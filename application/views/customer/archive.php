  ...
  <div class="dropdown-menu">
    <a class="dropdown-item" href="<?php echo base_url('customer/archive/show/10')?>">10</a>
    <a class="dropdown-item" href="<?php echo base_url('customer/archive/show/25')?>">25</a>
    <a class="dropdown-item" href="<?php echo base_url('customer/archive/show/50')?>">50</a>
	<a class="dropdown-item" href="<?php echo base_url('customer/archive/show/100')?>">100</a>
    <a class="dropdown-item" href="<?php echo base_url('customer/archive/show/all')?>">نمایش همه</a>
				    	...
				    	<table class="table datatable-selection-single table-striped">
                          ...
                          <th>ردیف</th>
							...
							<tbody id="search_cust" tyle="display: none;"><tr></tr></tbody>
							<tbody>
							<?php 
                    ...
                    <li class="text-danger-600"><a href="#"><i class="icon-trash"></i></a></li>
						...
						$num++;
								...
								نمایش <?php echo  $show + 1;?> تا <?php echo $num - 1; ?> از <?php echo $count;?>
								</td>
