...
<div class="row">
	<div class="col-lg-8">
		...
		<div class="panel panel-flat">
			...
			<h5 class="panel-title">مجموع معاملات</h5>
				...
				<img src="<?php echo base_url('files/');?>/assets/img/Annotation 2019-03-13 161608.jpg" </div>
	...
	<div class="col-lg-4">
						...
						<tbody>
								...
								<td>
									...
									<div class="media-body">
										<div class="media-heading">
											<a href="#" class="letter-icon-title">دلار</a>
										</div>
							...
							<tr>
								<td>
									...
									<div class="media-body">
										<div class="media-heading">
											<a href="#" class="letter-icon-title">یوان</a>
										</div>
							...
							<tr>
								<td>
									...
									<div class="media-body">
										<div class="media-heading">
											<a href="#" class="letter-icon-title">یورو</a>
										</div>
							...
							<tr>
								<td>
									...
									<div class="media-body">
										<div class="media-heading">
											<a href="#" class="letter-icon-title">درهم</a>
										</div>
		...
		<div class="panel panel-flat">
			<div class="panel-body">
<!-- Members online -->	<div class="panel-heading">
