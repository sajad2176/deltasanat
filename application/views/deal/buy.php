				...
				<div class="row">
					<div class="col-md-6">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input onkeyup="show_bank(this)" data-mask="aa-99-999-9999999999999999999" type="text" placeholder="IR-06-017-0000000123014682799" class="form-control">
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												<label>بانک:</label>
												<input type="text" placeholder="ملت،ملی،.." class="form-control" readonly>
											</div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input maxlength="16" type="text" name="format-credit-card" placeholder="9999999999" class="form-control">
										</div>
									</div>
						...
						<div class="text-right">
							<button type="submit" class="btn btn-primary">ثبت خرید <i class="icon-arrow-left13 position-right"></i></button>
						</div>
					</div>
