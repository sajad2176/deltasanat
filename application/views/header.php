			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown language-switch">
					<a class="dropdown-toggle" data-toggle="dropdown">
						<img src="<?php echo base_url('files/');?>assets/images/flags/gb.png" class="position-left" alt="">
						English
						<span class="caret"></span>
					</a>

					<ul class="dropdown-menu">
						<li><a class="deutsch"><img src="<?php echo base_url('files/');?>assets/images/flags/de.png" alt=""> Deutsch</a></li>
						<li><a class="ukrainian"><img src="<?php echo base_url('files/');?>assets/images/flags/ua.png" alt=""> Українська</a></li>
						<li><a class="english"><img src="<?php echo base_url('files/');?>assets/images/flags/gb.png" alt=""> English</a></li>
						<li><a class="espana"><img src="<?php echo base_url('files/');?>assets/images/flags/es.png" alt=""> España</a></li>
						<li><a class="russian"><img src="<?php echo base_url('files/');?>assets/images/flags/ru.png" alt=""> Русский</a></li>
					</ul>
				</li>
				...
				<li class="dropdown">
					...
					<div class="dropdown-menu dropdown-content width-350">
						...
						<ul class="media-list dropdown-content-body">
							...
							<li class="media">
								<div class="media-left"><img src="<?php echo base_url('files/');?>assets/images/placeholder.jpg" class="img-circle img-sm" alt=""></div>
								<div class="media-body">
									<a href="#" class="media-heading">
